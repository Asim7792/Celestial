...
const reasons = [
  {
    ...
    description:
      "Only premium N-Type solar cells with 22%+ efficiency from globally certified manufacturers",
  },
  {
    icon: Shield,
    title: "25-Year Performance Guarantee",
    description:
      "Industry-leading warranty covering panels, inverters, and workmanship with free replacements",
  },
  {
    icon: Clock,
    title: "Same-Month Installation",
    description:
      "From consultation to power generation in just 2-4 weeks. No delays, no excuses",
  },
  {
    icon: DollarSign,
    title: "Flexible 0% Financing",
    description:
      "Partner with leading banks for up to 10-year financing plans. Go solar with zero upfront cost",
  },
  {
    icon: Wrench,
    title: "Free 1-Year Maintenance",
    description:
      "Complimentary quarterly cleaning and performance checks for the first year after installation",
  },
  {
    icon: Users,
    title: "Local Pakistani Expertise",
    description:
      "6+ years serving Pakistani homes and businesses. We understand your energy challenges",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[45px] md:text-[65px] font-bold leading-[1.1] tracking-tighter text-neutral-900 mb-6">
            The <span style={{ color: "#1092CF" }}>Smart Choice</span> For
            <br />
            Pakistan&apos;s Energy Future
          </h2>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            We don&apos;t just install panels. We deliver complete peace of mind with
        ...
        <div
          className="relative overflow-hidden rounded-[50px] p-12 text-center text-white"
          style={{ backgroundColor: "#1092CF" }}
        >
          <div className="absolute inset-0 opacity-10">
            <div className="absolute -top-10 -right-10 text-[200px] font-black">
              ✓
            </div>
          </div>
          <div className="relative z-10">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
              If your system doesn&apos;t perform as promised in the first year,
              we&apos;ll fix it for free or provide a full refund. No questions
              asked.
            </p>
