  ...
  return (
    <section className="relative bg-[#F9F9F9] py-24 px-6 md:px-12 overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-20">
          <div className="max-w-2xl">
            ...
            <h2 className="text-[40px] md:text-[60px] font-bold leading-[1.1] tracking-tighter text-neutral-900">
              Description <span className="font-medium italic" style={{ color: '#1092CF' }}>Architecture</span> <br /> 
        ...
        {/* Isometric/Floorplan Image (Top Right Decal) */}
            ...
            >
              ...
              <div className="flex flex-col relative h-full">
                <div className="flex items-center gap-2 mb-3">
                   <span className="text-sm font-bold" style={{ color: '#1092CF' }}>{step.id}.</span>
      ...
      {/* Grid Mesh Overlay (Optional, matches the floor/wireframe look) */}
