...
const SavingsCalculator = () => {
  ...
  const estimatedSavings = bill * 0.87; // 87% average savings
  const annualSavings = estimatedSavings * 12;
  const systemCost = bill * 40; // Rough estimate: 40x monthly bill
  ...
  return (
    <section className="relative bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 py-24 px-6 md:px-12 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 right-10 text-[300px] font-black">₨</div>
      </div>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-[45px] md:text-[65px] font-bold leading-[1.1] tracking-tighter mb-6">
            Calculate Your <span style={{ color: '#1092CF' }}>Savings</span> In<br />
            60 Seconds
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-[40px] p-10 border border-white/20">
            ...
            <div className="space-y-6">
              {/* Monthly Bill Input */}
              <div>
                <label className="block text-sm font-bold mb-3">Monthly Electricity Bill (Rs.)</label>
              ...
              {/* Property Type */}
              <div>
                <label className="block text-sm font-bold mb-3">Property Type</label>
          ...
          <div className={`space-y-4 transition-all duration-500 ${showResults ? 'opacity-100' : 'opacity-50'}`}>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-bold uppercase tracking-wider text-white/60">Monthly Savings</span>
              </div>
              <div className="text-4xl font-black">₨ {estimatedSavings.toLocaleString()}</div>
              <div className="text-sm text-white/60 mt-1">Save up to 87% on your bill</div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-bold uppercase tracking-wider text-white/60">Annual Savings</span>
              </div>
              <div className="text-4xl font-black">₨ {annualSavings.toLocaleString()}</div>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-bold uppercase tracking-wider text-white/60">Payback Period</span>
              </div>
              <div className="text-4xl font-black">{paybackYears} Years</div>
              <div className="text-sm text-white/60 mt-1">Complete ROI timeline</div>
            </div>

            {/* 25-Year Savings */}
            <div className="bg-gradient-to-br from-[#1092CF] to-[#0B6DA0] rounded-3xl p-6 border border-[#1092CF]">
              <div className="text-sm font-bold uppercase tracking-wider mb-2">25-Year Total Savings</div>
              <div className="text-5xl font-black mb-2">₨ {(twentyFiveYearSavings / 10000000).toFixed(1)}Cr</div>
              <div className="text-sm opacity-90">With our 25-year warranty</div>
            </div>
        ...
        <p className="text-center text-sm text-white/40 mt-12 max-w-3xl mx-auto">
          * Estimates based on average 87% savings from 500+ installations. Actual savings may vary based on system size, location, and electricity consumption.
        </p>
      </div>
    </section>
  );
