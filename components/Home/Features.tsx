...
const Features = () => {
  const highlights = [
    { title: "Latest Technologies", desc: "Tier-1 N-Type solar cell technology." },
    { title: "High-Quality Designs", desc: "Custom mounting for maximum aesthetics." },
    { title: "25 Years Warranty", desc: "Long-term performance guarantees." },
    { title: "Residential Design", desc: "Optimized for home energy independence." },
  ];

  return (
    <section className="relative bg-white py-24 px-6 md:px-12 text-neutral-900 overflow-hidden">
      {/* Background Watermark Text - matching the interior design screenshot style */}
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <h2 className="text-[45px] md:text-[65px] font-bold leading-[1.1] tracking-tighter mb-10">
                ...
                And <span className="font-medium" style={{ color: '#1092CF' }}>Energy</span> Comes Alive
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12 mb-12">
                {highlights.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="mt-1 rounded-sm p-0.5" style={{ backgroundColor: '#1092CF' }}>
              ...
              <button className="group flex items-center gap-4 rounded-full border border-neutral-300 px-8 py-4 transition-all hover:bg-neutral-900 hover:text-white">
                ...
                <div className="flex h-8 w-8 items-center justify-center rounded-full text-white group-hover:bg-white group-hover:text-black transition-colors" style={{ backgroundColor: '#1092CF' }}>
