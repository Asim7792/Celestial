        ...
        <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-[60px] p-12 md:p-16 text-white text-center overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-12">
              Join 500+ satisfied customers who&apos;ve made the switch. Get your
              free consultation and custom quote today.
            </p>
            ...
            <Link href="/contact-us">
              <button className="group inline-flex items-center gap-4 px-12 py-6 bg-white text-neutral-900 rounded-full font-black text-xl uppercase tracking-wider hover:bg-[#1092CF] hover:text-white transition-all hover:scale-105 shadow-2xl">
                Get Your Free Quote
                <ArrowRight
