  ...
  return (
    <div className="font-sans bg-white">
      ...
      <section className="bg-[#1092CF] py-8 px-6">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">{commercialProjects.length}+</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Projects</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">80-250kW</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Capacity Range</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">PKR 3.5M+</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Total Savings</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">24/7</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Support</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-neutral-600 text-lg mt-6 max-w-2xl mx-auto">
              From offices to manufacturing facilities, we deliver large-scale solar installations 
              that drive down operational costs and boost sustainability.
            </p>
          </div>
      ...
      <section className="bg-[#F9F9F9] py-24 px-6">
        <div className="max-w-[1400px] mx-auto">
          <h3 className="text-3xl md:text-4xl font-bold text-center mb-12">Industries We Serve</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Corporate Offices', 'Manufacturing', 'Retail & Malls', 'Hospitality', 'Education', 'Healthcare', 'Warehousing', 'Agriculture'].map((industry) => (
              <div key={industry} className="bg-white p-6 rounded-[30px] text-center border border-neutral-100 hover:border-[#1092CF] hover:shadow-lg transition-all">
      ...
      <section className="bg-neutral-900 py-24 px-6 text-white text-center">
        <div className="max-w-[900px] mx-auto">
          <h2 className="text-[40px] md:text-[55px] font-bold leading-[1.1] tracking-tighter mb-6">
            Scale Your Business With <span className="text-[#1092CF]">Solar Energy</span>
          </h2>
          <p className="text-lg text-neutral-300 mb-10 max-w-2xl mx-auto">
            Reduce your energy costs by up to 70% and achieve sustainability goals. 
