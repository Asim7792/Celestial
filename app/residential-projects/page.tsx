      ...
      <section className="bg-[#1092CF] py-8 px-6">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">{residentialProjects.length}+</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Projects</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">5-20kW</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Capacity Range</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">85%+</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Avg. Savings</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-black">100%</div>
              <p className="text-sm font-bold text-black/80 uppercase tracking-wider">Satisfaction</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="mb-16 text-center">
            ...
            <h2 className="text-[40px] md:text-[55px] font-bold leading-[1.1] tracking-tighter text-neutral-900">
              Transforming <span className="text-[#1092CF]">Homes</span> Across Pakistan
            </h2>
            <p className="text-neutral-600 text-lg mt-6 max-w-2xl mx-auto">
              From compact townhouses to luxury villas, we've designed custom solar solutions 
              that deliver real savings and energy independence.
            </p>
          </div>
