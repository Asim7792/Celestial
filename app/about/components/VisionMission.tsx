      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            ...
            <p className="text-neutral-600 text-lg leading-relaxed mb-8">
              To be Pakistan&apos;s most trusted solar energy partner, transforming how homes and businesses 
              power their future through sustainable, reliable, and innovative solar solutions that deliver real savings.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-neutral-600 text-lg leading-relaxed mb-8">
              We empower Pakistani households and businesses to harness the power of the sun through 
              expert engineering, premium quality products, and unwavering customer support.
            </p>
