      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          <h2 className="text-[40px] md:text-[60px] font-bold leading-[1.1] tracking-tighter mb-6">
            ...
            Your{" "}
            <span className="text-[#1092CF] font-medium">Energy Future?</span>
          </h2>

          <p className="text-lg md:text-xl text-neutral-600 leading-relaxed mb-12 max-w-2xl mx-auto">
            Let&apos;s discuss how we can power your home or business with
            clean, reliable solar energy. Get your free consultation and custom
            quote today.
          </p>
          ...
          <p className="mt-6 text-sm text-neutral-400 italic">
            Join <span className="font-bold text-[#1092CF]">500+</span>{" "}
            satisfied clients who&apos;ve made the switch
          </p>
        </motion.div>
      </div>
    </section>
