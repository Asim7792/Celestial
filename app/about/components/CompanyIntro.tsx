        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-neutral-600 text-base md:text-lg leading-relaxed mb-6">
              Founded in 2021, Celestial Energy emerged from a vision to
              transform Pakistan&apos;s energy landscape. We combine
              cutting-edge solar technology with local expertise to deliver
              sustainable power solutions that empower homes and businesses.
            </p>

            <p className="text-neutral-600 text-base md:text-lg leading-relaxed">
              Our approach is simple: understand your energy needs, design a
              custom solution, and deliver excellence at every step. From
              residential rooftops to commercial-scale installations, we&apos;ve
              helped over 500 clients make the switch to clean, reliable solar
              energy.
            </p>
          </motion.div>
